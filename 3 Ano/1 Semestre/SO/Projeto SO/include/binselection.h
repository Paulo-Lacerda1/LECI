 ...
 *  \ingroup aux
 *  \brief Binary/group-version selection tools
 *
 * \details 
 ...
 *   one in namespace \c binary and one in namespace \c group:
 *   - the main version is a front end function, which allows to call
 *     the \c binary or \c group version, based on the binary activation map state;
 *   - the \c binary version is a binary available version of the function;
