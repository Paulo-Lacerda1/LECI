...
public class A08E02 {
		...
		for (int i = 0; i < pratos.length; i++) {
			...
			do {
				...
				if (pratos[i].addAlimento(aux)) {
					System.out.println("\tIngrediente " + index + " adicionado: " + aux);
					index++;
				} else
					System.out.println("\tERRO: não é possível adicionar Ingrediente " + index + ": " + aux);
			} while (index < 3);
	...
	public static Alimento randAlimento() {
		...
		case 0:
			res = new Carne(31.3, 25.3, 200, TipoCarne.FRANGO);
			break;
		case 1:
